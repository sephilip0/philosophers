...
int	permission_to_eat(t_list *table)
{
	...
	/*else
	{
		logvalue(table, "last_meal_prev: ", table->prev->last_meal);
		logvalue(table, "last_meal: ", table->last_meal);
		logvalue(table, "last_meal_next: ", table->next->last_meal);
	}*/
